...
func (r *Resource) GetCurrentState(ctx context.Context, obj interface{}) (interface{}, error) {
	...
	{
		clusterRoleBinding, err := r.k8sClient.RbacV1beta1().ClusterRoleBindings().Get(keyv2.ClusterRoleBindingName(customObject), apismetav1.GetOptions{})
		...
		clusterRoleBindingPSP, err := r.k8sClient.RbacV1beta1().ClusterRoleBindings().Get(keyv2.ClusterRoleBindingPSPName(customObject), apismetav1.GetOptions{})
		if apierrors.IsNotFound(err) {
