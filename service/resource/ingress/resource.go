...
func (r *Resource) GetUpdateState(obj, currentState, desiredState interface{}) (interface{}, interface{}, interface{}, error) {
	return []*v1beta1.Ingress{}, []*v1beta1.Ingress{}, []*v1beta1.Ingress{}, nil
}
...
func (r *Resource) ProcessCreateState(obj, createState interface{}) error {
	...
	if ingressesToCreate != nil {
		...
		r.logger.Log("cluster", key.ClusterID(customObject), "debug", "the ingresses do already exist in the Kubernetes API")
	}
...
func (r *Resource) ProcessDeleteState(obj, deleteState interface{}) error {
	...
	if ingressesToDelete != nil {
		...
		r.logger.Log("cluster", key.ClusterID(customObject), "debug", "the ingresses do not exist in the Kubernetes API")
	}
