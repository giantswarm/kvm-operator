...
func (r *Resource) GetCurrentState(ctx context.Context, obj interface{}) (interface{}, error) {
	...
	{
		clusterRoleBinding, err := r.k8sClient.RbacV1().ClusterRoleBindings().Get(key.ClusterRoleBindingName(customObject), apismetav1.GetOptions{})
		...
		clusterRoleBindingPSP, err := r.k8sClient.RbacV1().ClusterRoleBindings().Get(key.ClusterRoleBindingPSPName(customObject), apismetav1.GetOptions{})
		if apierrors.IsNotFound(err) {
