...
const (
	...
	// TODO use the right tag once https://github.com/giantswarm/k8s-kvm/pull/22
	// is merged.
	K8SKVMDockerImage  = "quay.io/giantswarm/k8s-kvm:fc3bbd9cf5fef4e8df7a29d0441726778ebdeffe"
